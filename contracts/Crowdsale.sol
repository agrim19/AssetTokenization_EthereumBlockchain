...
contract Crowdsale is Context, ReentrancyGuard {
    ...
    constructor (uint256 newRate, address payable newWallet, IERC20 newToken) {
        require(newRate > 0, "Crowdsale: rate is 0");
        require(newWallet != address(0), "Crowdsale: wallet is the zero address");
        require(address(newToken) != address(0), "Crowdsale: token is the zero address");
